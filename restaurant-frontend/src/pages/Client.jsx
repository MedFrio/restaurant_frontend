            ...
            <div className="mb-8 flex flex-wrap items-center gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded-lg shadow-sm leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-lg cursor-pointer text-gray-900" // AJOUTÉ text-gray-900
                >
                  {categories.map((cat) => (
                    <option key={cat} value={cat} className="text-gray-900"> {/* AJOUTÉ text-gray-900 pour les options aussi */}
                      {cat}
                    </option>
                  ))}
                </select>
